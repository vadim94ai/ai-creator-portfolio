---
name: impeccable
description: "A comprehensive design review, critique, and refinement skill for frontend interfaces. Transforms ordinary designs into award-winning, production-grade craft."
---
...
## Setup
1. Use view_file to read the project's DESIGN.md or DESIGN-REFERENCE.md.
2. Inspect target and incumbent visual truth before editing.
3. After resolving analysis, apply the craft floor principles immediately before any UI edit.
